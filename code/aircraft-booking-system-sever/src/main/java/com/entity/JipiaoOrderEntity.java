...
public class JipiaoOrderEntity<T> implements Serializable {
     ...
     * 支付状态
     */
    @ColumnInfo(comment="支付状态",type="varchar(200)")
     ...
     * 支付订单号
     */
    @ColumnInfo(comment="支付订单号",type="varchar(200)")
    @TableField(value = "order_pay_order")
    private String orderPayOrder;
    ...
    @JsonFormat(locale="zh", timezone="GMT+8", pattern="yyyy-MM-dd HH:mm:ss")
    @DateTimeFormat
    @ColumnInfo(comment="结算时间",type="timestamp")
    @TableField(value = "jieshuanshijian")
    private Date jieshuanshijian;
     ...
     * 设置：支付订单号
     */
    public void setOrderPayOrder(String orderPayOrder) {
        this.orderPayOrder = orderPayOrder;
    }

    /**
     * 获取：结算时间
     */
    public Date getJieshuanshijian() {
        return jieshuanshijian;
    }

    /**
     * 设置：结算时间
     */
    public void setJieshuanshijian(Date jieshuanshijian) {
        this.jieshuanshijian = jieshuanshijian;
    }
    ...
    public String toString() {
        return "JipiaoOrder{" +
            ...
            ", isPay=" + isPay +
            ", orderPayOrder=" + orderPayOrder +
            ", jieshuanshijian=" + DateUtil.convertString(jieshuanshijian,"yyyy-MM-dd") +
        "}";
    }
}
